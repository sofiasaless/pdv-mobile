import { DateTimePickerAndroid, default as DateTimePicker } from "@react-native-community/datetimepicker";
...
export const DatePicker: React.FC<DatePickerProps> = ({ dataPreEstabelecida, tipo, tamanBtn, setarData }) => {
  ...
  return (
    <>
      <Button size={tamanBtn} status="info" onPress={showDatePicker}>
        {
          (tipo === 'date')?
